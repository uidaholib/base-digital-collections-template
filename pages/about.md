...
This digital collection consists of images, documents, and interviews from the Selway-Bitterroot Wilderness History Project, an exploration into the human aspects of the Selway-Bitterroot Wilderness, one of the largest wilderness areas in the United States. 
The National Endowment for the Humanities funded project was active from 2010 to 2014, led by Debbie Lee (Washington State University) and Dennis Baird (University of Idaho Library).

[Original Selway-Bitterroot Wilderness History Project Website](https://sbw.lib.uidaho.edu/index.html){:.btn .btn-outline-pride-gold .my-3}
 
Although still accessible, the original project website is currently unmaintained and may have broken features and links.
This collection gathers the project's items together to ensure access to the materials, but does not reproduce all the original features.

The original site was divided into three content sections, all of which can be found in this collection: 

- [Wilderness Voices]({{ '/browse.html#Wilderness%20Voices' | relative_url }}) - podcasts featuring curated highlights from oral histories.
- [Wilderness Pages]({{ '/browse.html#Wilderness%20Pages' | relative_url }}) - historical documents relating to the wilderness experience.
- [Wilderness Portraits]({{ '/browse.html#Wilderness%20Portraits' | relative_url }}) - photographs showing wilderness people and places.
...
Originally posted at `selwaybitterrootproject.wordpress.com` ([web archive version](https://web.archive.org/web/20181125102629/https://selwaybitterrootproject.wordpress.com/)), the Wilderness Voices podcast curated excerpts from longer oral history interviews conducted by the SBW project. 
