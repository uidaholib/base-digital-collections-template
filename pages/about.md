...
{% include feature/jumbotron.html objectid="footballcovers12" position="top" %} 
...
<div class="row">
<div class="col-md-6">{% include feature/image.html objectid="footballcovers9" %}</div>
<div class="col-md-6">{% include feature/image.html objectid="footballcovers64" %}</div>
</div>
...
{:.mt-5}
{% include feature/image.html objectid="footballcovers14" %}
