...
- [Lionel Hampton Jazz Festival](https://www.lib.uidaho.edu/digital/jazzfest/) events were held in the Kibbie Dome for a number of years.
- The [Campus Planning History digital collection](https://www.lib.uidaho.edu/digital/lrcdp/) includes campus plans, including the Kibbie Dome.
- [More photos of the Kibbie Dome](https://www.lib.uidaho.edu/digital/campus/buildings/kibbiedome.html) can be found in the [University of Idaho Campus Photographs Collection](https://www.lib.uidaho.edu/digital/campus/).
...
{% include feature/image.html objectid="campus02840" width="75" %}

While a new stadium was under construction during the 1969 and 1970 seasons, University of Idaho football home games were played in nearby Pullman, Washington, and other locations. In October 1971, the University of Idaho proudly hosted Idaho State University in the brand new Idaho Stadium. The new facility, built on the former Neale Stadium site, featured concrete bench seating and enclosed luxury boxes for VIPs and press. Perhaps energized by the investment in their program, the Vandal football team won the Big Sky Conference in 1971 with its best record to date.  

{% include feature/image.html objectid="kibbiedome211" width="50" %}

### Construction of the Kibbie Dome

Originally, Idaho Stadium was planned as an outdoor venue with a seating capacity of more than 20,000, co-located with a large indoor arena for basketball and cultural events. When financing for that project fell through, campus leadership set its sights on a multipurpose facility that could be constructed on a tight budget.  

The U of I put out a bid for an enclosed stadium, and a small Idaho-based company answered the call. Trus Joist Corporation[^3] proposed a design centered on wood micro-lam arches and a steel truss system. Following the completion of the building in 1975, the Kibbie Dome received the Structural Achievement Award from the American Society of Civil Engineers. 

{% include feature/image.html objectid="kibbiedome247" %}

The Kibbie-ASUI Activity Center was named in honor of two critical sources of support for constructing the indoor pavilion. William H. Kibbie, a University of Idaho student in the 1930s, made a $300,000 gift to kickstart fundraising for the activity center, and later donated more funds for the renovation of the Kibbie Dome roof.[^4] Support from the Associated Students of the University of Idaho (ASUI) was also critical, and concern emerged early on that the common nickname "Kibbie Dome" failed to acknowledge student financial support for the building[^5] (another party objected to its being termed a "dome", when its shape is, in fact, an arch or vault[^6]). Together, students advocated for a multipurpose event space and dedicated significant student fees to the effort. In 2023, local credit union P1FCU pledged support and gained naming rights for the next decade.

{% include feature/image.html objectid="kibbiedome104" width="75" %}
...
{% include feature/image.html objectid="kibbiedome146" width="50" %}
...
Athletes of all stripes have found a home in the Kibbie Dome. Vandal football, basketball, and track and field competitors may immediately come to mind, but rodeo riders, youth athletes, and Special Olympians are also part of the arena's history. As a multipurpose activity center, the Kibbie Dome has adapted to accommodate an impressive diversity of athletic events. Spectators, for their part, are always close to the action and protected from whatever inclement weather might come rolling through the Palouse.  

{% include feature/image.html objectid="kibbiedome142" %}

The first football game under the dome pitted U of I against in-state rivals Boise State University on October 11, 1975. By all accounts it was a thrilling game, which ended in a 31-31 tie, the only draw recorded in dome history. Just a few months later, the inaugural basketball game ended in victory for the Vandal men on January 21, 1976. For nearly a decade, basketball in the dome was played on a hard rubber court installed directly on the concrete floor. A second-hand hardwood court purchased in 1984 improved overall conditions for players, though reportedly diminished what was a significant home-court advantage. Basketball players and fans further benefitted from a custom configuration in the form of Cowan Spectrum. News coverage in 2001 described it as a "more intimate setting" than the multi-purpose activity center.[^7]  

{% include feature/image.html objectid="kibbiedome049" %}
...
{% include feature/image.html objectid="kibbiedome035" %}
...
The U of I has long relied on the Kibbie Dome to enrich student life. Chart-topping musical acts offer hardworking students a chance to let their hair down. The world class Lionel Hampton Jazz Festival offers entertainment and education at once. Impressive marching band showcases are as exciting as the games they complement. Events organized by students, like the Tutxinmepu Powwow, broaden horizons and make space for community. Even as some events have found a new home in the ICCU Arena, which completed planners' original vision for sports facilities a half-century after ground broke on Idaho Stadium, the Kibbie Dome remains a beloved site of campus life.

{% include feature/image.html objectid="kibbiedome097" %}

Events organized by private groups, like businesses or local organizations, round out the Kibbie Dome calendar and bring fun and unique opportunities to the Palouse. In 1977 Moscow children and kids-at-heart were treated to acrobats, clowns, and exotic animals at the American Continental Circus. Shoppers could peruse carpet samples or inspect the latest models of RVs at semi-annual home and auto shows. For many years, students and residents of western Moscow cast their votes inside the Kibbie Dome, which was an official polling place for Latah County.  
